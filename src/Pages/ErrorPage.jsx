...
const ErrorPage = () => {
  ...
  return (
    <section className='bg-white '>
      <div className='w-4/5 mx-auto flex items-center min-h-screen'>
        <div className='flex flex-col items-center max-w-sm mx-auto text-center'>
          ...
          <h1 className=' md:text-9xl font-bold text-[#D3D9E3]  text-3xl'>
            <span>404</span>
          </h1>
          <p className='mt-4 text-3xl font-bold text-gray-500 '>Seems like the page you’re  searching for doesn’t exist</p>
