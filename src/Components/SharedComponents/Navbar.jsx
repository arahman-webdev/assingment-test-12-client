...
const Navbar = () => {
  ...
  return (
    <>
      {/* Main Navbar */}
      <nav
        className={`fixed  top-0 left-0 z-50 w-full p-4 shadow-md font-semibold transition-all duration-300 ${isScrolled ? 'bg-[#FFFFFF] text-black' : 'bg-transparent opacity-100 text-white'
          }`}
      >
